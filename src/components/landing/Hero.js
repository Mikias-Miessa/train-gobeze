          ...
          >
            ...
            >
              <Link sx={{
                ...
                textAlign: 'center',
                boxShadow:
                  'rgb(254 126 1 / 15%) 0rem 0.1875rem 0.1875rem 0rem, rgb(254 126 1 / 20%) 0rem 0.1875rem 0.0625rem -0.125rem, rgb(254 126 1 / 15%) 0rem 0.0625rem 0.3125rem 0rem', transition: 'all 150ms ease-in 0s'
              }} href='#courses'>
                Explore Courses
              </Link>
            </Box>
